...
class FaceDetector {
    ...
    drawStatusInfo() {
        ...
        // SỬA: Thêm error handling cho phương thức getCurrentPersonsCount
        let currentFaces = 0;
        try {
    ...
    updateTrackingStats(trackedFaces) {
        ...
        try {
            // SỬA: Thêm error handling toàn diện
            ...
            try {
                if (this.faceTracker && typeof this.faceTracker.getTotalAppearances === 'function') {
